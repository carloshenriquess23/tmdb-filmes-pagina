...
export default function HomeFilmes(){
    ...
    async function respMelhorAvaliados(){
        ...
        try{
            ...
            alert('Ocorreu um erro ao chamar os filmes melhor avaliados');
        }
    }
    ...
    async function respMaisPopularesBrasileiros(){
        ...
        try{
            ...
            alert('Ocorreu um erro ao chamar os filmes brasileiros mais populares');
        }
    }
        ...
        <div className='page-home-filmes'>
            ...
            <section className='section-pesquisa'>
                ...
                <div className='box-pesquisa'>
                    ...
                    <Link to={'/filme/buscar/'+nomeFilme}>
            ...
            <section className='section-listagem-filmes'>
                ...
                <div className='container-melhores-nacionais'>
                    ...
                    <h3 className='titulo'>Filmes Brasileiros Mais Populares</h3>
                    <div className='listagem'>

                    {melhoresBrasileiros.map(item => 
                        <CardFilme 
                            id={item.id}
                            poster={item.poster_path}
                            avaliacao={item.vote_average.toFixed(1)}
